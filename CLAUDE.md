...
| PRES-025 | 2026-08-23 | **IFC reales en montaje y anatomía.**  (337 elem) → slide 07 en 5 fases con la animación vigente, wireframe de malla completa (decisión: todas las aristas, 322k); reparto fundación 4 · vigas 8 · suelo ventilado 108 (emparrillado = suelo, decisión) · módulo 30 · piel 187.  → pieza 01 de la Anatomía (reemplaza placeholder). Textos de fase actualizados (Ecopilote 88,9 × 1600). Horneador reutilizable . Deck 8,2 MB. |
| PRES-026 | 2026-08-23 | **El deck pasa a Git**: repo , rama , identidad de commits anónima (Philisteos + noreply). El flujo de trabajo sigue ahí; Dropbox queda como espejo para Javier cuando se pida «guardado importante». |
